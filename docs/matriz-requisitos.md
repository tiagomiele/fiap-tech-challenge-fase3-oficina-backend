...
|---|---|---|
| Contexto, funcionalidades e evolução | [Visão de negócio e engenharia](visao-negocio-e-engenharia.md) | Jornada da OS e evolução Fase 2 → Fase 3 |
| Modelo arquitetural e práticas | [Visão de negócio e engenharia](visao-negocio-e-engenharia.md#5-modelo-arquitetural-por-aplicação) | Clean Architecture, serverless e Infrastructure as Code |
...
| CI/CD em cada projeto | [Ciclos CI/CD](cicd-promocao.md) | Workflows e runs em [Evidências](evidencias.md) |
| `main` protegida e uso de PR | [Ciclos CI/CD](cicd-promocao.md) | Confirmação final deve ser anexada |
| Homologação e produção | [Ciclos CI/CD](cicd-promocao.md) | Ambientes, branches e workspaces separados |
...
| Monitoramento e observabilidade | [Observabilidade](observabilidade-evidencias.md) | New Relic; evidências finais pendentes |
